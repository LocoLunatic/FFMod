...
namespace FFMod.Content.DamageClasses
{
	public class SentinalClass : DamageClass
	{
		...
		public override void SetDefaultStats(Player player) {
			...
			player.GetCritChance<SentinalClass>() += 4;
			player.GetArmorPenetration<SentinalClass>() += 10;
